...
NAME=kproximate-template # The name of the resulting template
STORAGE=RBD-DATASTORE01 # The name of the proxmox storage to store the template in
VLAN=2520 # The vlan tag for the template network interface, leave as empty string for no tag
